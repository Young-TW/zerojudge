# a189. NOI2008 Day1.2.设计路线

## 內容

Z 国坐落于遥远而又神奇的东方半岛上，在小Z 的统治时代公路成为这里主
...
输入文件第一行包含三个正整数N、M、Q，其中N 表示城市个数，
...
输出文件应包含两行。第一行为一个整数，表示最小的“不便利值”。 
第二行为一个整数，表示使“不便利值”达到最小时不同的设计路线的方
法总数 mod Q 的值。
